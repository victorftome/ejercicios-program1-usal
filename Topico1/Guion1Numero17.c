...
int main() {
	...
	long suma = 0; // Se opto por usar un long ya que se pueden generar numeros de gran tamaño. Se inicializa a 0.
	...
	// ya que no se ejecuta ninguna iteración del bucle for.
